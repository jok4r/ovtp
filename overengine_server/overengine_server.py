...
sc = {
    'server_ip': '0.0.0.0',
    'server_port': 888,
    'auth_keys_dir': os.path.join('/var/lib/overengine', 'keys'),
}
cfg = ovcfg.Config(std_config=sc, file='server.json', cfg_dir_name='overengine').import_config()


class OverEngineServer:
    # saved_public_keys = {}
    # cr = ovcrypt.OvCrypt()
    class Handler:
